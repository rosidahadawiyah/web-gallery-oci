    ...
    <div class="row">
        ...
        <div class="col-12 col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    {{-- tapilkan error validasi jika ada --}}
                    @if ($errors->any())
                    ...
                    @endif
                        ...
                        {{-- tepilkan pesan berhasil jika ada --}}
                        @if (session('success'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="card">
                                    <img src="{{ asset('images/' . $image->file) }}" alt="{{ $image->title }}" class="img-fluid border">
                                    <div class="p-2">
                                        <h5>{{ $image->title }}</h5>
